...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        function fetch_data() {
            $.ajax({
                url: "<?php echo base_url('Trichy_airport/get_trichymaster_airline_table') ?>",
                method: "GET",
                dataType: "JSON",
        ...
        $(document).on('click', '#btn_add', function() {
            ...
            */
            ...
            //alert(airline);
            $.ajax({
                url: "<?php echo base_url('Trichy_airport/insert_master_airline_table'); ?>",
                method: "POST",
                data: {
                    airline:airline,
					iata:iata,
        ...
        $(document).on('blur', '.table_data', function() {
            ...
            //alert(number);
            $.ajax({
                url: "<?php echo base_url('Trichy_airport/update_master_airline_table'); ?>",
                method: "POST",
                //dataType:"JSON",
                data: {
                    id: id,
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.ajax({
                    url: "<?php echo base_url('Trichy_airport/delete_master_airline_table'); ?>",
                    method: "POST",
                    data: {
                        id: id
                    },
