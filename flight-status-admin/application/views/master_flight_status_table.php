...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        function fetch_data() {
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/get_flight_status_table') ?>",
                method: "GET",
                dataType: "JSON",
                success: function(data) {
                    ...
                    for (var count = 0; count < a.length; count++) {
						...
						html += '<td id="airport_name_t" class="table_data" data-row_id="' + a[count].id + '" data-column_name="airport_name" contenteditable>' + a[count].airport_name + '</td>';
                        
						html += '<td id="city_t" class="table_data" data-row_id="' + a[count].id + '" data-column_name="city" contenteditable>' + a[count].city + '</td>';
						html += '<td id="country_t" class="table_data" data-row_id="' + a[count].id + '" data-column_name="country" contenteditable>' + a[count].country + '</td>';
                        html += '<td id="source_t" class="table_data" data-row_id="' + a[count].id + '" data-column_name="source" contenteditable>' + a[count].source + '</td>';
						html += '<td id="airport_url_t" class="table_data" data-row_id="' + a[count].id + '" data-column_name="airport_url" contenteditable>' + a[count].airport_url + '</td>';
						html += '<td id="create_at_t" class="table_data" data-row_id="' + a[count].id + '" data-column_name="create_at" contenteditable>' + a[count].creat_at + '</td>';
        ...
        $(document).on('click', '#btn_add', function() {
            ...
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/insert_flight_status_table'); ?>",
                method: "POST",
                data: {
                   airport:airport,
				   url:url,
        ...
        $(document).on('blur', '.table_data', function() {
            ...
            */
		    // alert(table_column);
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/update_flight_status_table'); ?>",
                method: "POST",
                //dataType:"JSON",
                data: {
                    id: id,
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.ajax({
                    url: "<?php echo base_url('Airport_Controller/delete_flight_status_table'); ?>",
                    method: "POST",
                    data: {
                        id: id
                    },
