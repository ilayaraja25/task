...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        function fetch_data() {
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/get_TrichyMasterArrivalSelenium_table') ?>",
                method: "GET",
                dataType: "JSON",
                success: function(data) {
					...
					html1 += '<tr>';
                    html1 += '<td id="from" contenteditable placeholder="Enter From place"></td>';
                    ...
                    html1 += '<td id="arrival" contenteditable placeholder="Enter the Departure"></td>';
        ...
        $(document).on('click', '#btn_add', function() {
            ...
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/insert_arrival_selenium_table'); ?>",
                method: "POST",
                data: {
                    origin:origin,
					airline:airline,
        ...
        $(document).on('blur', '.table_data', function() {
            ...
            */
		    // alert(table_column);
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/update_arrival_selenium_table'); ?>",
                method: "POST",
                //dataType:"JSON",
                data: {
                    id: id,
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.ajax({
                    url: "<?php echo base_url('Airport_Controller/delete_arrival_selenium_table'); ?>",
                    method: "POST",
                    data: {
                        id: id
                    },
