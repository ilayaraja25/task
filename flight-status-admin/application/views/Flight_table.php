...
<body>
    <div class="container box">
        <h3 align="center">Flights Table</h3></br>
        <div class="table-responsive">
            ...
            <table id="ch_table" class="table table-striped table-bordered" Chennai Airport>
                <thead>
                    <tr>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        function fetch_data() {
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/get_TrichyMasterFlight_table') ?>",
                method: "GET",
                dataType: "JSON",
                success: function(data) {
                    ...
                    for (var count = 0; count < a.length; count++) {
						...
						html += '<td id="origin_t" class="table_data" data-row_id="' + a[count].id + '" data-column_name="origin" contenteditable>' + a[count].from + '</td>';
                        html += '<td id="destination_t" class="table_data" data-row_id="' + a[count].id + '" data-column_name="destination" contenteditable>' + a[count].dest + '</td>';
                    ...
                    html1 += '<td id="origin" contenteditable placeholder="Enter the airline"></td>';
        ...
        $(document).on('click', '#btn_add', function() {
            ...
            */
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/insert_flight_table'); ?>",
                method: "POST",
                data: {
                    airport:airport,
					airline:airline,
        ...
        $(document).on('blur', '.table_data', function() {
			...
			var from = $(this).closest('tr').children('td#origin_t').text();
			var dest = $(this).closest('tr').children('td#destination_t').text();
            ...
            */
			// alert(id);
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/update_flight_table'); ?>",
                method: "POST",
                //dataType:"JSON",
                data: {
                    id: id,
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.ajax({
                    url: "<?php echo base_url('Airport_Controller/delete_flight_table'); ?>",
                    method: "POST",
                    data: {
                        id: id
                    },
