...
<body>
    ...
    <div class="container box">
        <h3 align="center">Error Log</h3></br>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        function fetch_data() {
            $.ajax({
                url: "<?php echo base_url('Trichy_airport/get_trichymaster_error_log_table') ?>",
                method: "GET",
                dataType: "JSON",
                success: function(data) {
                    ...
                    for (var count = 0; count < a.length; count++) {
                        ...
                        html += '<td id="error_statement_t" class="table_data" data-row_id="' + a[count].place_id + '" data-column_name="error_statement" contenteditable>' + a[count].error_statement + '</td>';
                        html += '<td id="create_at_t" class="table_data" data-row_id="' + a[count].place_id + '" data-column_name="create_at" contenteditable>' + a[count].create_at + '</td>';
