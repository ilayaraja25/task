...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        function fetch_data() {
            $.ajax({
                url: "<?php echo base_url('Trichy_airport/get_TrichyMasterArrivalSelenium_table') ?>",
                method: "GET",
                dataType: "JSON",
        ...
        $(document).on('click', '#btn_add', function() {
            ...
            $.ajax({
                url: "<?php echo base_url('Trichy_airport/insert_arrival_selenium_table'); ?>",
                method: "POST",
                data: {
                    origin:origin,
					airline:airline,
        ...
        $(document).on('blur', '.table_data', function() {
            ...
            */
		    // alert(table_column);
            $.ajax({
                url: "<?php echo base_url('Trichy_airport/update_arrival_selenium_table'); ?>",
                method: "POST",
                //dataType:"JSON",
                data: {
                    id: id,
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.ajax({
                    url: "<?php echo base_url('Trichy_airport/delete_arrival_selenium_table'); ?>",
                    method: "POST",
                    data: {
                        id: id
                    },
