...
<body>
    <div class="container box">
        <h3 align="center">Master Departure Table</h3></br>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        function fetch_data() {
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/get_TrichyMasterDeparture_table') ?>",
                method: "GET",
                dataType: "JSON",
                success: function(data) {
                    ...
                    for (var count = 0; count < a.length; count++) {
                        ...
                        html += '<td id="origin_t" class="table_data" data-row_id="' + a[count].id + '" data-column_name="origin" contenteditable>' + a[count].origin + '</td>';
                        html += '<td id="destination_t" class="table_data" data-row_id="' + a[count].id + '" data-column_name="destination" contenteditable>' + a[count].destination + '</td>';
                    ...
                    html1 += '<td id="origin" contenteditable placeholder="Enter the flight"></td>';
                    html1 += '<td id="destination" contenteditable placeholder="Enter the airline"></td>';
        ...
        $(document).on('click', '#btn_add', function() {
            ...
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/insert_departure_table'); ?>",
                method: "POST",
                data: {
                    origin:origin,
        ...
        $(document).on('blur', '.table_data', function() {
            ...
            */
		    // alert(table_column);
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/update_departure_table'); ?>",
                method: "POST",
                //dataType:"JSON",
                data: {
                    id: id,
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.ajax({
                    url: "<?php echo base_url('Airport_Controller/delete_departure_table'); ?>",
                    method: "POST",
                    data: {
                        id: id
                    },
