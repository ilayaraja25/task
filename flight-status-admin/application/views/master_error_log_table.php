...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        function fetch_data() {
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/get_trichymaster_error_log_table') ?>",
                method: "GET",
                dataType: "JSON",
                success: function(data) {
                    ...
                    for (var count = 0; count < a.length; count++) {
                        ...
                        html += '<td id="file_t" class="table_data" data-row_id="' + a[count].place_id + '" data-column_name="file" >' + a[count].file + '</td>';
