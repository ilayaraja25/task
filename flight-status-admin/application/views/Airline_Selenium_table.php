...
<body>
    <div class="container box">
        <h3 align="center">Airlines Selenium Table</h3></br>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        function fetch_data() {
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/get_TrichyMasterAirlineSelenium_table') ?>",
                method: "GET",
                dataType: "JSON",
        ...
        $(document).on('click', '#btn_add', function() {
            ...
            */
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/insert_airline_selenium_table'); ?>",
                method: "POST",
                data: {
                    // airport:airport,
					airline:airline,
        ...
        $(document).on('blur', '.table_data', function() {
            ...
            */
			// alert(id);
            $.ajax({
                url: "<?php echo base_url('Airport_Controller/update_airline_selenium_table'); ?>",
                method: "POST",
                //dataType:"JSON",
                data: {
                    id: id,
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.ajax({
                    url: "<?php echo base_url('Airport_Controller/delete_airline_selenium_table'); ?>",
                    method: "POST",
                    data: {
                        id: id
                    },
