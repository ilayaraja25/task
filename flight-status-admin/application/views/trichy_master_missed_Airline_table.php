...
<body>
    ...
    <div class="container box">
        <h3 align="center">Master Missed Airline Table</h3></br>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        function fetch_data() {
            $.ajax({
                url: "<?php echo base_url('Trichy_airport/get_trichymaster_missed_Airline_table') ?>",
                method: "GET",
                dataType: "JSON",
                success: function(data) {
                    ...
                    for (var count = 0; count < a.length; count++) {
                        ...
                        html += '<td id="airline_t" class="table_data" data-row_id="' + a[count].si_no + '" data-column_name="airline" contenteditable>' + a[count].airline + '</td>';
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.ajax({
                    url: "<?php echo base_url('Trichy_airport/delete_master_missed_airline_table'); ?>",
                    method: "POST",
                    data: {
                        id: id
                    },
