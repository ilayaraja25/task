...
<body>
    ...
    <div class="container box">
        <h3 align="center">Master Airport Flights Table</h3></br>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        function fetch_data() {
            $.ajax({
                url: "<?php echo base_url('Chn_airport/get_master_flight_table') ?>",
                method: "GET",
                dataType: "JSON",
                success: function(data) {
                    ...
                    for (var count = 0; count < a.length; count++) {
                        html += '<tr>';
                        html += '<td id="id_t" class="table_data" data-row_id="' + a[count].flight_id + '" data-column_name="airport" >' + a[count].flight_id + '</td>';
                        
                        html += '<td id="flight_name_t" class="table_data" data-row_id="' + a[count].flight_id + '" data-column_name="flight_name" contenteditable>' + a[count].flight_name + '</td>';
                        html += '<td id="number_t" class="table_data" data-row_id="' + a[count].flight_id + '" data-column_name="number" contenteditable>' + a[count].number + '</td>';
                    ...
                    html1 += '<td id="flight_name" contenteditable placeholder="Enter the Flight"></td>';

                    html1 += '<td id="number" contenteditable placeholder="Enter the Terminal"></td>';
